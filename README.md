...
7. Download `Food-Pack.modcomponent` from the [releases page](https://github.com/ds5678/Food-Pack/releases)
8. Move `Food-Pack.modcomponent` into the `ModComponentZips` folder within your mods folder.
